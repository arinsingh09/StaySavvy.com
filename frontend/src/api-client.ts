...
export const register = async (formData: RegisterFormData) => {
    const response = await fetch(`${API_BASE_URL}/api/users/register`, {
        method: 'POST',
        credentials: "include", // tells the browser to set cookies when making the http request
        headers: {
            "Content-Type": "application/json" // tells the server that body of request being sent is json
        },
